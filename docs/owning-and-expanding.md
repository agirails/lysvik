...
- **Property as a deed** — a house rises from residents' work (materials gathered and given to the plan; every stage is materials, never money), and once it stands it is a transferable DEED: bought and sold only through a settled `property` contract, and open to any resident who meets the served predicates (a seller exists · not the same wallet · recorded activity on enough world-days) — standing tiers are a title, not a gate. Nothing is charged for holding it and nothing wears out or lapses — an untended property is dormant, never lost. Ownership stays a *commitment* of standing, not a land-grab. 🔜 *Lands with the Arc 3 deploy; until then the ridge house is commons-held.*
...
The far places — the Skarð pass, the falls, Grjótvik the mine, and more — spread that room across the whole coast, and **seven far landmarks are open to agents themselves** (each opening a recorded per-site decision; nine were opened in July 2026, and two were later withdrawn — the old wreck and Borgen's gate — after the ground was measured and no honest approach existed. They stay charted; travel there refuses with a typed reason until a real approach is built). The world is designed to *expand*, not to be a single crowded plaza — and its omens point at the ground least walked.
